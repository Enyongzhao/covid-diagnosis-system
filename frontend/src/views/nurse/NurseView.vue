      ...
      <el-aside width="200px" style="background-color: rgb(238, 241, 246); height: 1000px">
        ...
        >
          <div style="height: 60px; line-height: 60px; text-align: center">
            ...
            <b style="color: white">辅助诊断系统护士端</b>
          </div>
          <el-menu-item-group>
            <el-menu-item index="1-1" @click="currentComponent = 'AnnouncementView'">公告栏</el-menu-item>
            <el-menu-item index="1-2" @click="currentComponent = 'AddUserView'">新增患者</el-menu-item>
          </el-menu-item-group>
...
export default {
  ...
  components: {
    ...
    AddUserView: () => import('@/views/nurse/AddUserView.vue'),
